                ...
                <div className="our-fleet-main-section"> 
                    ...
                    <div className="our-fleet-grid">
                        ...
                        <div> 
                            ...
                            <h2 className="grid-heading font-color-white2">Environmental className</h2> 
                        ...
                        <div> 
                            ...
                            <h2 className="grid-heading font-color-white2">Business className</h2> 
                            <p className="font-color-white2">These vehicles are designed to cater for the high expectations of our corporate clients and can be ordered in advance for removal of any taxi insignia.<br/>All drivers of our Business className vehicles undergo Advanced Customer Services training to meet a higher standard of presentation.</p>
                        </div> 
